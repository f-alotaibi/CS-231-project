...
// TODO: Values
void testValues() {
    customerList.addNode(Customer("4166", "Moath Aljubair", "055471619", "m.aljubair@email.com", 150));
    customerList.addNode(Customer("6717", "Faleh Alotaibi", "057071972", "f.alotaibi@email.com", 90));

    Pharmacy.addNode(Branch("002", "Zulfi", "050549412"));
    Pharmacy.addNode(Branch("001", "Riyadh", "058696066"));

    Node<Branch>* temp = Pharmacy.getHead();
    temp->value.drugList.addNode(Drug("80602", "Panadol extra", 8, 10));
    temp->value.drugList.addNode(Drug("70283", "Flutab", 9.9, 9));
    temp->value.pharmacistList.addNode(Pharmacist("5778", "Majed Almutairi", "14133", 15340, 60));

    temp = temp->next;
    temp->value.drugList.addNode(Drug("34785", "Otrvin", 13.80, 5));
    temp->value.drugList.addNode(Drug("38214", "Vicks throat drop menthol", 8.63, 18));
    temp->value.pharmacistList.addNode(Pharmacist("7183", "Bader Alslamah", "61635", 13660, 49));
    temp->value.pharmacistList.addNode(Pharmacist("2360", "Ibrahem Altowala", "82048", 12090, 44));
}
...
void branchMenu() {
    ...
    case 2: {
        ...
        cout << "Phone: ";
        cin >> phone;
        Pharmacy.addNode(Branch(id, address, phone));
        break;
    }
    case 3: {
        if (Pharmacy.isEmpty()) {
    ...
    case 4: {
        ...
        Node<Branch>* cNode = Pharmacy.getHead(), *nNode = NULL;
        while (cNode) {
            nNode = cNode->next;
            delete cNode;
            cNode = nNode;
...
void customerMenu()
{
    ...
    case 2:
    {
        ...
        cin >> email;
        customerList.addNode(Customer(id, name, phone, email, 0));
    ...
    case 3:
    {
        ...
        if (index != -1)
        {
            Node<Customer>* currentCustomer = customerList.getHead();
            int count = 0;
            ...
            case 4:
                ...
                cout << "Customer points has been modified successfully!" << endl;
                break;
            default:
                cout << "Invalid choice." << endl;
                break;
    ...
    case 4:
    {
        ...
        if (!customerList.isEmpty())
        {
            Node<Customer>* cNode = customerList.getHead(), * nNode = NULL;
            while (cNode) {
                nNode = cNode->next;
                delete cNode;
                cNode = nNode;
...
void pharamacistMenu()
{
    ...
    case 1:
    {
        ...
        current->value.pharmacistList.displayList();
        break;
    }
    case 2:
    {
        ...
        cin >> salary;
        current->value.pharmacistList.addNode(Pharmacist(id, name, licenseID, salary, 0));
    ...
    case 3:
    {
        ...
        if (index != -1)
        {
            Node<Pharmacist>* currentPharmacist = current->value.pharmacistList.getHead();
            int count = 0;
    ...
    case 4:
    {
        ...
        Node<Pharmacist>* cNode = current->value.pharmacistList.getHead(), * nNode = NULL;
        while (cNode) {
            nNode = cNode->next;
            delete cNode;
            cNode = nNode;
        ...
        delete cNode;
        current->value.pharmacistList.setLength(0);
...
void drugMenu()
{
    ...
    case 1:
    {
        ...
        current->value.drugList.displayList();
        break;
    }
    case 2:
    {
        ...
        cin >> price;
        current->value.drugList.addNode(Drug(id, title, price, 0));
    ...
    case 3:
    {
        ...
        if (index != -1)
        {
            Node<Drug>* currentDrug = current->value.drugList.getHead();
            int count = 0;
    ...
    case 4:
    {
        ...
        if (!current->value.drugList.isEmpty())
        {
            Node<Drug>* cNode = current->value.drugList.getHead(), * nNode = NULL;
            while (cNode) {
                nNode = cNode->next;
                delete cNode;
                cNode = nNode;
            ...
            delete cNode;
            current->value.drugList.setLength(0);

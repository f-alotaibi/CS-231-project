...
Stack<Branch> Pharmacy;
Stack<Customer> customerList;
...
// TODO: Values
void testValues() {
    customerList.push(Customer("4166", "Moath Aljubair", "055471619", "m.aljubair@email.com", 150));
    customerList.push(Customer("6717", "Faleh Alotaibi", "057071972", "f.alotaibi@email.com", 90));

    Pharmacy.push(Branch("002", "Zulfi", "050549412"));
    Pharmacy.push(Branch("001", "Riyadh", "058696066"));

    Node<Branch>* temp = Pharmacy.getHead();
    temp->value.drugList.push(Drug("80602", "Panadol extra", 8, 10));
    temp->value.drugList.push(Drug("70283", "Flutab", 9.9, 9));
    temp->value.pharmacistList.push(Pharmacist("5778", "Majed Almutairi", "14133", 15340, 60));

    temp = temp->next;
    temp->value.drugList.push(Drug("34785", "Otrvin", 13.80, 5));
    temp->value.drugList.push(Drug("38214", "Vicks throat drop menthol", 8.63, 18));
    temp->value.pharmacistList.push(Pharmacist("7183", "Bader Alslamah", "61635", 13660, 49));
    temp->value.pharmacistList.push(Pharmacist("2360", "Ibrahem Altowala", "82048", 12090, 44));
}
...
void branchMenu() {
    ...
    case 2: {
        ...
        cout << "Phone: ";
        cin >> phone;
        Pharmacy.push(Branch(id, address, phone));
        break;
    }
    case 3: {
        if (Pharmacy.isEmpty()) {
...
void customerMenu()
{
    ...
    case 2:
    {
        ...
        cin >> email;
        customerList.push(Customer(id, name, phone, email, 0));
...
void pharamacistMenu()
{
    ...
    case 1:
    {
        ...
        current->value.pharmacistList.displayStack();
        break;
    }
    case 2:
    {
        ...
        cin >> salary;
        current->value.pharmacistList.push(Pharmacist(id, name, licenseID, salary, 0));
...
void drugMenu()
{
    ...
    case 1:
    {
        ...
        current->value.drugList.displayStack();
        break;
    }
    case 2:
    {
        ...
        current->value.drugList.push(Drug(id, title, price, 0));
